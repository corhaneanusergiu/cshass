// relay + IR receiver sensor; 4 relays included, IR - HX1838 used also for some FM modulators
...
const unsigned long tUpdate=120000; // update interval if no state change
unsigned long t0;
byte IrAct;
