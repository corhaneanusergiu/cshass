...
#define MQTT_FIRST_SENSORID	200  		// If you want manually configured nodes below this value. 255 = Disable
#define MQTT_LAST_SENSORID	254 		// 254 is max! 255 reserved.
#define MQTT_BROKER_PREFIX	"M"	// First prefix in MQTT tree, keep short!
